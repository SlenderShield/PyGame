...
def player_animation():
	# display walk animation or else jump
...
# Snail obstacle list with animation
...
# Introduction page
intro_surf = test_font.render('Pixel Runner', False, (64, 64, 64))
...
while True:
	...
	if GAME_ACTIVE:
		...
		# Player activity
		PLAYER_ACTIVE += 1
		player_rect.bottom += PLAYER_ACTIVE
		if player_rect.bottom >= 300:
